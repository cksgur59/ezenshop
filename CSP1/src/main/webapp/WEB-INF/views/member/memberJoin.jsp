...
<div class="content_area" style="text-align: center;">
	...
	<form id="join_form" method="post">
		...
		Password: <input type="password" name="pw" class="pw_input">
		<span class="final_pw_ck">비밀번호를 입력해주세요.</span>
		<br><br>
		
		Password(확인): <input type="password" name="pw2" class="pwck_input">
		...
		이름: <input name="name" class="user_input">
		...
		핸드폰: <input class="phone_input" name="phone" type="tel">
		...
		<input type="button" class="join_button" value="가입" style="border: 5px; border-radius: 5px; width: 280px; padding: 10px 15px; margin-top: 15px; color: white; background-color: #3A1D1D">
